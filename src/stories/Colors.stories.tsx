...
const semanticGroups = [
    ...
    {
        title: "Text & Forms",
        colors: ["defaultText", "defaultContrastText", "headingText", "formElement"]
    },
    {
        title: "Brand",
        colors: ["primary", "primaryLight", "primaryXLight", "primaryContrast", "secondary", "secondaryLight", "border", "focus"]
    },
    {
        title: "Status",
        colors: ["success", "successLight", "successXLight", "warning", "warningLight", "warningXLight", "error", "errorLight", "errorXLight"]
    }
];
...
const paletteGroups = [
    ...
    {
        title: "Palette: Sky",
        colors: ["sky-50", "sky-100", "sky-200", "sky-300", "sky-400", "sky-500", "sky-600", "sky-700", "sky-800", "sky-900"]
    },
    {
        title: "Palette: Amber",
        colors: ["amber-50", "amber-100", "amber-200", "amber-300", "amber-400", "amber-500", "amber-600", "amber-700", "amber-800", "amber-900"]
    },
    {
        title: "Palette: Red",
