...
const render = (args: PDFProps) => {
    ...
    return (
        <PDF {...args}>
            <div className={["page", args.signedDocument ? "signed-document" : "", args.orientation === "landscape" ? "landscape" : ""].join(" ")}>
...
const logoExample = <img src={dibkLogoUrl} alt="Direktoratet for byggkvalitet" className="heading-logo" />;
...
const captionH1Example = <caption style={{ "--size": 1 } as CSSProperties}>Caption with size 1 example</caption>;
const captionH2Example = <caption style={{ "--size": 2 } as CSSProperties}>Caption with size 2 example</caption>;
const captionH3Example = <caption style={{ "--size": 3 } as CSSProperties}>Caption with size 3 example</caption>;
const captionH4Example = <caption style={{ "--size": 4 } as CSSProperties}>Caption with size 4 example</caption>;
const captionH5Example = <caption style={{ "--size": 5 } as CSSProperties}>Caption with size 5 example</caption>;
...
const textParagraphsExample = (
    <p>
        ...
        <span className="text-italic">Text with class .text-italic</span> <span className="text-red">Text with class .text-red</span>{" "}
