...
export const InheritedFromCompactList: Story = {
    ...
    render: (args) => (
        <DescriptionList compact titleWidth="220px">
            <DescriptionTerm {...args} />
            <DescriptionDetails>Description details 1</DescriptionDetails>
            <DescriptionTerm compact={false}>Description term 2 (opts out of compact)</DescriptionTerm>
            <DescriptionDetails compact={false}>Description details 2</DescriptionDetails>
        </DescriptionList>
    )
};
