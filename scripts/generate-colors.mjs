...
const headerLines = ["/* This file is auto-generated by scripts/generate-colors.mjs */", "/* Do not edit this file directly. */", ""];

const tokensCssLines = [...headerLines, ":root {", ...keys.map((key) => `  --${key}: ${tokens[key]};`), "}", ""];

const themeCssLines = [...headerLines, "@theme {", ...keys.map((key) => `  --${key}: ${tokens[key]};`), "}", ""];
...
const tokensCssPath = path.join(projectRoot, "src/style/generated/tokens.css");
const themeCssPath = path.join(projectRoot, "src/style/generated/theme.css");
